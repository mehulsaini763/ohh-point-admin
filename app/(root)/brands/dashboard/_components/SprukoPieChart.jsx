...
const SprukoPieChart = ({ totalScans, uniqueScans }) => {
  const data = [
    { name: "Total Scans", value: totalScans, color: "#8A4FFF" },
    { name: "Unique Scans", value: uniqueScans, color: "#FF7F50" },
  ];
  return (
    <div
      style={{
      ...
      className="relative shadow bg-white rounded-lg row-span-2"
    >
