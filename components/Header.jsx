...
const Header = () => {
  ...
  return (
    <div className=" md:min-h-[4rem] min-h-[4rem] w-full flex flex-row justify-between items-center py-4 md:px-12 px-2 gap-4 bg-white">
      ...
      <RxHamburgerMenu
        ...
        className=" text-3xl  md:block block text-oohpoint-grey-300"
      />
      <div className="flex gap-2 items-center justify-around sm:justify-center sm:gap-8 sm:w-auto w-full">
        ...
        <div
          ...
          className=" cursor-pointer flex gap-4 justify-center items-center"
        >
