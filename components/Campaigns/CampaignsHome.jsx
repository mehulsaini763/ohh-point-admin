...
const CampaignsHome = ({ show, setShow }) => {
  const {
    campaigns,
    setIsEditCampaign,
    setEditedCampaign,
  ...
  const transformCampaignsData = (campaigns) => {
    return campaigns.map((campaign) => ({
      ...
      button2: "Edit", // Button to edit campaign
    }));
  };
  ...
  return (
    <>
      {isEditCampaign ? (
        <CreateCampaign isEdit={true} campaign={editedCampaign} />
      ) : (
            ...
            <>
              ...
              {/* 
                <div className="w-full flex flex-wrap lg:justify-between justify-around items-center gap-4 lg:gap-2 mt-10">
                  <Card head="Total Scans" count={totalScans} Icon={MdOutlineCampaign} />
                  <Card head="Unique Scans" count={uniqueScans} Icon={MdOutlineCampaign} />
              ...
              {/* <div className="w-full flex flex-wrap lg:justify-between justify-around items-start gap-4 lg:gap-2">
                ...
                <div className=" flex flex-col w-[30%] min-w-[18rem] gap-4">
                  ...
                  />
                  <Card
                    head="Average Budget per Campaign"
                    count={`Rs. ${average.toFixed()}`}
                    Icon={MdOutlineCampaign}
                  />
                </div>
              </div> */}
